! function() { var a = [];
    a.push({ familyName: "proxima-nova", className: "proxima-nova", weight: "600", style: "normal" }), a.push({ familyName: "proxima-nova", className: "proxima-nova", weight: "normal", style: "normal" }), a.push({ familyName: "proxima-nova", className: "proxima-nova", weight: "300", style: "normal" }), a.push({ familyName: "museo-slab", className: "museo-slab", weight: "500", style: "normal" }), a.push({ familyName: "proxima-nova-sc", className: "proxima-nova-sc", weight: "300", style: "normal" }), window.FortAwesomeConfig = { autoA11y: { enabled: !0 }, asyncLoading: { enabled: !0 }, reporting: { enabled: !1 }, useUrl: "fonticons-free-fonticons.netdna-ssl.com/kits/ffe176a3/publications/72113", code: "ffe176a3", familyName: "FontAwesomeSite", prefix: "fas", testString: "&", typefaces: a } }();
! function() {
    ...
    function b(a) { "undefined" != typeof MutationObserver && new MutationObserver(a).observe(document, { childList: !0, subtree: !0 }) }

    function c(a) { var b, c, d, e;
    ...
    function() {
        ...
        function b(a, b, c) { Object.defineProperty ? Object.defineProperty(a, b, { get: c }) : a.__defineGetter__(b, c) } if (!("undefined" == typeof window.Element || "classList" in document.documentElement)) { var c = Array.prototype,
            ...
            a.prototype = { add: function(a) { this.contains(a) || (d.call(this, a), this.el.className = this.toString()) }, contains: function(a) { return -1 != this.el.className.indexOf(a) }, item: function(a) { return this[a] || null }, remove: function(a) { if (this.contains(a)) { for (var b = 0; b < this.length && this[b] != a; b++);
                        e.call(this, b, 1), this.el.className = this.toString() } }, toString: function() { return f.call(this, " ") }, toggle: function(a) { return this.contains(a) ? this.remove(a) : this.add(a), this.contains(a) } }, window.DOMTokenList = a, b(Element.prototype, "classList", function() { return new a(this) }) } }(); var d = function(a, b, c) {
        ...
        h = { observe: function(a, b) { for (var c = b.prefix, d = function(a) { var b = a.weight ? "-" + a.weight : "",
                            d = a.style ? "-" + a.style : "",
                            ...
                            j = function(a) { h.remove(c + f + "-" + a), h.remove(c + g + "-" + a) };
                        i("loading"), new e(a.familyName).load(a.testString).then(function() { i("ready"), j("loading") }, function() { i("failed"), j("loading") }) }, f = 0; f < a.length; f++) d(a[f]) } },
        i = { load: function(a) { var b = document.createElement("link");
                b.href = a, b.media = "all", b.rel = "stylesheet", document.getElementsByTagName("head")[0].appendChild(b) }, loadAsync: function(a) { d(a) } }; try { if (window.FortAwesomeConfig) { var j = window.FortAwesomeConfig,
                k = j.useUrl,
